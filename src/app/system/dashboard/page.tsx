    ...
    return (
        <div className="min-h-screen bg-[#f5f0eb] dark:bg-[#121212] pb-20 font-sans text-[#1a1a1a] dark:text-gray-100 transition-colors duration-200">
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-10 mt-12 md:mt-16 space-y-12">
                <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 pb-10 border-b border-[#e0dbd5] dark:border-gray-800 transition-colors">
                    <div className="space-y-4">
                        <span className="inline-flex items-center gap-2 text-xs uppercase tracking-widest text-[#555] dark:text-gray-400">
                            <span className="w-1.5 h-1.5 rounded-full bg-[#1a1a1a] dark:bg-gray-300" />
                            KES/CAD Analysis
                        </span>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
                        <button
                            ...
                            className={`px-8 py-4 rounded-full font-bold text-white transition-all duration-300 shadow-xl
                                ${training ? 'bg-[#555] dark:bg-gray-700 cursor-wait' : 'bg-[#1a1a1a] dark:bg-white dark:text-[#1a1a1a] hover:bg-[#333] dark:hover:bg-gray-200 hover:scale-[1.02] active:scale-98'}`}
                        >
                ...
                {error && (
                    <div className="bg-[#fcf8f8] dark:bg-red-500/10 border border-[#f5e0e0] dark:border-red-500/20 p-6 rounded-2xl flex items-center gap-4">
                        <div className="w-2 h-2 rounded-full bg-[#d94040]" />
                        <p className="text-sm font-medium text-[#d94040] dark:text-red-400">{error}</p>
                    </div>
                )}
